  ...
  handleInvokeAgent(args) {
    ...
    const phaseGuidance = {
      ...
      Generate: {
        ...
        teamPattern: 'Developer (sonnet) implements via TDD; Reviewer (sonnet) validates code quality. One task per session'
      },
      Evaluate: {
        recommended: ['tester', 'security'],
        focus: 'Verification, edge case testing, security review',
        models: { tester: 'sonnet', security: 'opus' },
        teamPattern: 'Tester (sonnet) verifies acceptance criteria; Security (opus) performs adversarial review'
      }
    };
