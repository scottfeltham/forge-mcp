...
class ToolHandlers {
  ...
  async newCycle(args) {
    ...
    try {
      ...
      this.logger.warn('Could not create initial documentation:', docError.message);
    }
    ...
    return {
      ...
      text: '🚀 **New FORGE Development Cycle Created**\n\n' +
            ...
            `• PRD: docs/prd/${this.docsManager.sanitizeFileName(feature)}-prd.md\n` +
            `• Test Plan: docs/testing/${this.docsManager.sanitizeFileName(feature)}-test-scenarios.md\n\n` +
