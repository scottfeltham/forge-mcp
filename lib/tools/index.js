  ...
  handleInvokeAgent(args) {
    ...
    const phaseGuidance = {
      Focus: {
        ...
        models: { architect: 'opus', security: 'opus', documentation: 'haiku' },
        teamPattern: 'Architect (opus) leads scope definition; Security (opus) identifies threat landscape; Documentation (haiku) drafts PRD structure'
      },
      Orchestrate: {
        recommended: ['architect'],
        focus: 'C4 L2-L3 architecture, dependency mapping, task breakdown',
        models: { architect: 'opus' },
        teamPattern: 'Architect (opus) works solo on system decomposition and dependency analysis'
      },
      Refine: {
        recommended: ['tester', 'architect'],
        focus: 'Acceptance criteria, interfaces, edge cases - NO CODE',
        models: { tester: 'sonnet', architect: 'opus' },
        teamPattern: 'Architect (opus) defines interfaces; Tester (sonnet) writes acceptance criteria and enumerates edge cases'
      },
      Generate: {
        recommended: ['developer', 'reviewer'],
        focus: 'TDD implementation, code review after each task',
        models: { developer: 'sonnet', reviewer: 'sonnet' },
        teamPattern: 'Developer (sonnet) implements via TDD; Reviewer (sonnet) checks TDD compliance, criteria alignment, and code quality after each task. One task per session'
      },
      Evaluate: {
        recommended: ['tester', 'reviewer', 'security'],
        focus: 'Verification, final code review, edge case testing, security review, cycle review summary',
        models: { tester: 'sonnet', reviewer: 'sonnet', security: 'opus' },
        teamPattern: 'Tester (sonnet) verifies acceptance criteria; Reviewer (sonnet) performs final code review for security, integration contracts, and overall quality; Security (opus) performs adversarial review'
      }
    };
