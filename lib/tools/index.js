  ...
  constructor(stateManager, options = {}) {
    ...
    this.tools = {
      ...
      forge_new_cycle: {
        ...
        description: 'Create a new development cycle. Starts in Focus phase with required outputs checklist.',
        inputSchema: {
          type: 'object',
          properties: {
            name: {
      ...
      forge_advance_phase: {
        ...
        description: 'Advance to the next phase. Validates requirements unless force=true.',
        inputSchema: {
          type: 'object',
          properties: {
            cycleId: {
